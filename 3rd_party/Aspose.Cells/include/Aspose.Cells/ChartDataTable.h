...
public:
    ...
    [[deprecated]] ASPOSE_CELLS_API bool GetHasBorderHorizontal();
    /// <summary>
    /// True if the chart data table has horizontal cell borders
    /// </summary>
    /// <remarks>NOTE: This property is now obsolete. Instead,
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use ChartDataTable.HasHorizontalBorder property, instead.
    [[deprecated]] ASPOSE_CELLS_API void SetHasBorderHorizontal(bool value);
    /// <summary>
    /// True if the chart data table has horizontal cell borders
    /// </summary>
    ASPOSE_CELLS_API bool GetHasHorizontalBorder();
    /// <summary>
    /// True if the chart data table has horizontal cell borders
    /// </summary>
    ASPOSE_CELLS_API void SetHasHorizontalBorder(bool value);
    /// <summary>
    ...
    [[deprecated]] ASPOSE_CELLS_API bool GetHasBorderVertical();
    /// <summary>
    /// True if the chart data table has vertical cell borders
    /// </summary>
    /// <remarks>NOTE: This property is now obsolete. Instead,
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use ChartDataTable.HasVerticalBorder property, instead.
    [[deprecated]] ASPOSE_CELLS_API void SetHasBorderVertical(bool value);
    /// <summary>
    /// True if the chart data table has vertical cell borders
    /// </summary>
    ASPOSE_CELLS_API bool GetHasVerticalBorder();
    /// <summary>
    /// True if the chart data table has vertical cell borders
    /// </summary>
    ASPOSE_CELLS_API void SetHasVerticalBorder(bool value);
    /// <summary>
    ...
    [[deprecated]] ASPOSE_CELLS_API bool GetHasBorderOutline();
    /// <summary>
    /// True if the chart data table has outline borders
    /// </summary>
    /// <remarks>NOTE: This property is now obsolete. Instead,
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use ChartDataTable.HasOutlineBorder property, instead.
    [[deprecated]] ASPOSE_CELLS_API void SetHasBorderOutline(bool value);
    /// <summary>
    /// True if the chart data table has outline borders
    /// </summary>
    ASPOSE_CELLS_API bool GetHasOutlineBorder();
    /// <summary>
    /// True if the chart data table has outline borders
    /// </summary>
    ASPOSE_CELLS_API void SetHasOutlineBorder(bool value);
    /// <summary>
