...
public:
    ...
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual Vector<U16String> GetShortTextOf12Months();
    /// <summary>
    /// Gets the local text of 4 Quaters.
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual Vector<U16String> GetTextOf4Quaters();
    /// <summary>
    /// Gets the local text of "Years".
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfYears();
    /// <summary>
    /// Get the local text of "Quarters".
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfQuarters();
    /// <summary>
    /// Gets the local text of "Months".
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfMonths();
    /// <summary>
    /// Gets the local text of "Days".
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfDays();
    /// <summary>
    /// Gets the local text of "Hours".
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfHours();
    /// <summary>
    /// Gets the local text of "Minutes".
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfMinutes();
    /// <summary>
    /// Gets the local text of "Seconds"
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfSeconds();
    /// <summary>
    /// Gets the local text of "Range"
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API virtual U16String GetTextOfRange();
    /// <summary>
