...
public:
    ...
    /// <param name="topRow">The top row index.</param>
    /// <param name="top">Represents the vertical  offset from its top row, in unit of pixel. </param>
    /// <param name="leftColumn">The left column index.</param>
    /// <param name="left">Represents the horizontal offset from its left column, in unit of pixel. </param>
    /// <returns>The new <see cref="Shape"/> object.</returns>
    ASPOSE_CELLS_API Shape AddCopy(const Shape& sourceShape, int32_t topRow, int32_t top, int32_t leftColumn, int32_t left);
    /// <summary>
    /// Adds a checkbox to the worksheet.
    /// </summary>
    /// <param name="upperLeftRow">Upper left row index.</param>
    /// <param name="top">Represents the vertical  offset of checkbox from its top row, in unit of pixel. </param>
    ...
    /// </summary>
    /// <param name="upperLeftRow"> Upper left row index.</param>
    /// <param name="top">Represents the vertical  offset of textbox from its top row, in unit of pixel. </param>
    /// <param name="upperLeftColumn">Upper left column index.</param>
    /// <param name="left">Represents the horizontal offset of textbox from its left column, in unit of pixel. </param>
    ...
    /// </summary>
    /// <param name="topRow">The top row index.</param>
    /// <param name="top">The vertical  offset its top row, in unit of pixel.</param>
    /// <param name="leftColumn">The left column index.</param>
    /// <param name="left">The horizontal offset from its left column, in unit of pixel.</param>
    /// <param name="height">The height of equation, in unit of pixel.</param>
    /// <param name="width">The width of equation, in unit of pixel.</param>
    /// <returns></returns>
    ASPOSE_CELLS_API TextBox AddEquation(int32_t topRow, int32_t top, int32_t leftColumn, int32_t left, int32_t height, int32_t width);
    /// <summary>
