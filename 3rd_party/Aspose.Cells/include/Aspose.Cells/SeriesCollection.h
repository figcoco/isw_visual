...
public:
    ...
    [[deprecated]] ASPOSE_CELLS_API void ChangeSeriesOrder(int32_t sourceIndex, int32_t destIndex);
    /// <summary>
    /// Directly changes the orders of the two series.
    /// </summary>
    /// <param name="sourceIndex">The current index</param>
    /// <param name="destIndex">The dest index</param>
    ASPOSE_CELLS_API void SwapSeries(int32_t sourceIndex, int32_t destIndex);
    /// <summary>
