...
public:
    ...
    /// </summary>
    ASPOSE_CELLS_API U16String GetXValuesFormatCode();
    /// <summary>
    /// Represents format code of X Values's NumberList.
    /// </summary>
    ASPOSE_CELLS_API void SetXValuesFormatCode(const U16String& value);
    /// <summary>
    /// Represents format code of X Values's NumberList.
    /// </summary>
    ASPOSE_CELLS_API void SetXValuesFormatCode(const char16_t* value);
    /// <summary>
